      ...
      <div class="flex flex-col-reverse items-center md:flex-row lg:items-end">
        <div class="pt-24 pr-8 pb-24 text-center md:pb-12 md:w-1/2 md:text-left">
          <h1 class="relative z-10 text-5xl font-bold md:text-6xl font-display">
            Learn the
            <span
              class="relative after:content-[url(../public/img/scratch.svg)] after:absolute after:-top-2 after:-right-6 after:-z-1"
            >
              best
            </span>
            ways for staying
            <span
              class="relative after:content-[url(../public/img/decoration.svg)] after:absolute after:-bottom-2 after:-right-8 after:-z-1"
            >
              productive
            </span>
          </h1>
        ...
        <div class="flex items-end w-1/2 border-b border-gray-400">
          <img src="../public/img/illustration.svg" alt="" />
        </div>
      </div>
    </div>
          ...
          >
            <div class="flex items-center space-x-3">
              <div class="relative">
                ...
                />
                <Component :is="feature.icon" class="relative" />
              </div>
              <div class="relative">
                <span
                  :class="feature.color"
